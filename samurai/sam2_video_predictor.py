...
from samurai.modeling.sam2_base import NO_OBJ_SCORE, SAM2Base
from samurai.utils.misc import concat_points, fill_holes_in_mask_scores, load_video_frames
import cv2
import numpy as np
import gc
class SAM2VideoPredictor(SAM2Base):
    ...
    def init_streaming_state(self, first_frame, offload_state_to_cpu=False, offload_video_to_cpu=False):
        ...
        # Initialize the same data structures as in the original init_state
        inference_state["point_inputs_per_obj"] = {}
        inference_state["mask_inputs_per_obj"] = {}
        inference_state["cached_features"] = {}
        inference_state["constants"] = {}
    ...
    def _clear_unused_frames(self, output_dict, frame_idx):
        ...
        non_cond_outputs = output_dict["output_dict"]["non_cond_frame_outputs"]
        # Identify high-quality frames based on Samurai criteria
        non_cond_frames = list(non_cond_outputs.keys())[::-1]
        quality_frames = []
